...
export default function NecesitasAyudaConTusArchivos() {
  return (
    <div className='relative w-full md:h-52 overflow-hidden flex items-center justify-center'>
        ...
        <div className='absolute flex items-center justify-center space-x-4 md:space-x-36'>

            <div className='flex flex-col items-center space-y-3 md:space-y-6 pt-2 md:pt-0 pb-2 md:pb-0'>
                <p className='text-lg md:text-5xl font-extrabold text-gray-900 md:font-outline-2'>¿Necesitas ayuda con tu archivo?</p>
                <Link to={'/plantillas-editables'}
                className='text-white whitespace-nowrap text-sm md:text-2xl font-semibold 
