...
export default function StickersDePiso({imgSrc, product, description}) {
  ...
  {imagePreviews.length === 0 && (
    <img className='h-[300px] md:h-[450px]' src="/images/productos/ejemplo-piso.jpg" alt="" />
  )}
    ...
    <div className=' h-[400px] w-[450px] rounded-xl border-b-4 border-r-4 shadow-inner flex items-center justify-center'>
      {imagePreviews.map((previewUrl, index) => (
        ...
        <div className='flex flex-col items-center justify-center px-6 md:px-0 space-y-6 mb-16 mt-16'>
           <p className='text-4xl font-semibold text-gray-900'>Stickers para piso</p>
           <p className='text-gray-900 font-semibold'>Crea señalización en tus espacios o dales vida con estos <br />
           stickers resistentes y fáciles de limpiar, antideslizantes <br />
           ideales para colocar en tus pisos.</p>
