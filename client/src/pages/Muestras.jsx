...
export default function Muestras({imgSrc, product, description}) {
  ...
  {imagePreviews.length === 0 && (
    <img className='h-[300px] md:h-[450px]' src="/images/productos/ejemplo-muestras.png" alt="" />
  )}
    ...
    <div className=' h-[400px] w-[450px] rounded-xl border-b-4 border-r-4 shadow-inner flex items-center justify-center'>
      {imagePreviews.map((previewUrl, index) => (
        ...
        <div className='flex flex-col items-center justify-center px-6 md:px-0 space-y-6 mb-16 mt-16'>
           <p className='text-4xl font-semibold text-gray-900'>Set de muestras</p>
           <p className='text-gray-900 font-semibold'>Conoce la calidad de nuestros materiales con tus <br />
