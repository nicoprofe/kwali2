...
export default function AdminBackup3() {
    ...
    async function handlePreviewsSubmit(e) {
        e.preventDefault()
        ...
        const imgUrls = await Promise.all(
            ...
            .catch((error) => {
                toast.error("Las imágenes no se guardaron correctamente")
                return
            })
        )
        ...
        const docRef = await addDoc(db, "orders", formData)
        toast.success("Las imágenes han sido grardadas correctamente")
                                ...
                                <div className='flex items-center justify-around mt-3 ' key={order.id}>
                                    ...
                                    <div className='flex space-x-3'>
                                        ...
                                        <label htmlFor={`fileInput-${index}`} className='cursor-pointer'>
                                            ...
                                            <img 
                                            src={order.image || "/images/identidad/isotipo.png"} 
                                            alt={order.id} 
                                            className='h-24 w-24'
                                            onClick={() => setSelectedOrderImage(order.image || '/images/identidad/isotipo.png')}/>
